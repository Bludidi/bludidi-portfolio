  ...
  return (
    <nav className="navigation">
      ...
      <div className="my-socials">
        <a href="https://github.com/Bludidi" aria-label="GitHub">
          <FaIcons.FaGithub size={25} className="my-social-icons" />
        </a>
        <a href="https://twitter.com/@BB_Ludidi" aria-label="Twitter">
          <FaIcons.FaTwitter size={25} className="my-social-icons" />
        </a>
        <a href="https://linkedin.com/in/brian-ludidi" aria-label="LinkedIn">
          <AiIcons.AiOutlineLinkedin size={25} className="my-social-icons" />
        </a>
        <a href="mailto:bludidi5@gmail.com" aria-label="Email">
