...
const Icons = () => (
  <>
    <div className="social-icons">
      <a href="https://github.com/Bludidi" target="_blank" rel="noreferrer">
        <img src={myImage1} alt="github icon" className="socials" />
      </a>
      <a href="/Contact" rel="noreferrer">
        <img src={myImage2} alt="mail icon" className="socials" />
      </a>
      <a href="https://twitter.com/BB_Ludidi" target="_blank" rel="noreferrer">
        <img src={myImage3} alt="twitter icon" className="socials" />
      </a>
      <a href="https://www.linkedin.com/in/brian-ludidi" target="_blank" rel="noreferrer">
